...
2. Riset Komunikasi Serial Arduino Dengan Aplikasi Database dengan Rails
2. Riset Komunikasi Serial Arduino Dengan Output Servo Posisi(Dijadikan Portal), dan Database Rails 
